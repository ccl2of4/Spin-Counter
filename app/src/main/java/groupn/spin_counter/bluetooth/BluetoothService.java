...
package groupn.spin_counter.bluetooth;
...
public class BluetoothService {
    ...
    private static final UUID MY_UUID_SECURE =
            UUID.fromString("a7d8230e-abb9-4136-8c03-00bc0b9283f7");
    ...
    private synchronized void setState(int state) {
        ...
        mHandler.obtainMessage(groupn.spin_counter.bluetooth.Constants.MESSAGE_STATE_CHANGE, state, -1).sendToTarget();
    }
